...
public class spycloudAuthNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(spycloudAuthNodePlugin.currentVersion, 
				Collections.singletonList(spycloudAuthNode.class));
	}
	...
	public void upgrade(String fromVersion) throws PluginException {
        pluginTools.upgradeAuthNode(spycloudAuthNode.class);
	...
	public String getPluginVersion() {
		return spycloudAuthNodePlugin.currentVersion;
	}
}
